...
CREATE UNIQUE INDEX ON "quiz_answer_options" ("question_id", "label");
...
COMMENT ON COLUMN "quiz_instance_players"."current_score" IS 'Dùng để hiển thị Leaderboard realtime trong phòng';

COMMENT ON COLUMN "quiz_answer_options"."label" IS 'A, B, C...';
