...
CREATE TYPE "public"."coin_reason" AS ENUM('QUIZ_COMPLETION_REWARD', 'QUIZ_PERFECT_BONUS', 'DAILY_CHALLENGE_REWARD', 'STREAK_MILESTONE_REWARD', 'BADGE_REWARD', 'TOURNAMENT_PLACEMENT_REWARD', 'TIP_SENT', 'FLAIR_PURCHASED', 'SUPPRESS_RECOMMENDED_PURCHASED', 'ADMIN_ADJUSTMENT', 'REFUND');--> statement-breakpoint
CREATE TYPE "public"."comment_report_status" AS ENUM('open', 'reviewed', 'dismissed', 'actioned');--> statement-breakpoint
CREATE TYPE "public"."comment_vote_value" AS ENUM('upvote', 'downvote');--> statement-breakpoint
...
CREATE TYPE "public"."notification_type" AS ENUM('achievement_earned', 'badge_unlocked', 'rank_achievement', 'rank_improvement', 'period_winner', 'tournament_invite', 'tournament_starting', 'tournament_completed', 'tournament_won', 'streak_milestone', 'friend_request', 'friend_accepted', 'quiz_review_received', 'weekly_summary', 'system_announcement', 'followed', 'comment_reply', 'comment_mention', 'comment_created', 'badge_earned', 'badge_revoked', 'tournament_started', 'tournament_reminder', 'rank_improved', 'rank_milestone', 'instance_player_joined', 'instance_started', 'instance_xp_earned', 'instance_closed', 'instance_player_disconnected', 'profile_updated', 'settings_updated', 'password_changed', 'password_reset_requested', 'password_reset_completed', 'account_deleted', 'session_revoked', 'all_other_sessions_revoked', 'oauth_linked', 'oauth_unlinked');--> statement-breakpoint
CREATE TYPE "public"."quiz_difficulty" AS ENUM('easy', 'medium', 'hard');--> statement-breakpoint
CREATE TYPE "public"."quiz_instance_status" AS ENUM('open', 'countdown', 'running', 'closed', 'finished');--> statement-breakpoint
...
CREATE TYPE "public"."social_feed_activity_type" AS ENUM('badge_earned', 'badge_revoked', 'rank_milestone', 'peak_rank_achieved', 'tournament_joined', 'tournament_completed', 'tournament_won', 'comment_created', 'quiz_completed', 'quiz_milestone', 'instance_created', 'instance_joined', 'instance_completed');--> statement-breakpoint
...
CREATE TABLE "auth_audit_logs" (
	"audit_log_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid,
...
CREATE TABLE "oauth_accounts" (
	"oauth_account_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
CREATE TABLE "password_reset_tokens" (
	"password_reset_token_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid NOT NULL,
...
CREATE TABLE "sent_verification_tokens" (
	"sent_token_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid,
	"token_hash" text NOT NULL,
...
CREATE TABLE "bookmark_collections" (
	"collection_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid NOT NULL,
	"name" text NOT NULL,
	"description" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "bookmarked_quizzes" (
	"bookmark_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
CREATE TABLE "quiz_answer_options" (
	"option_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
CREATE TABLE "quiz_attempt_answers" (
	"attempt_answer_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
CREATE TABLE "quiz_attempts" (
	"attempt_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid NOT NULL,
...
CREATE TABLE "quiz_instance_players" (
	"instance_player_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
CREATE TABLE "quiz_instances" (
	"instance_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"quiz_version_id" uuid NOT NULL,
	...
	CONSTRAINT "quiz_instances_countdown_started_at_consistent" CHECK ((status = 'countdown' AND countdown_started_at IS NOT NULL) OR (status <> 'countdown' AND countdown_started_at IS NULL))
);
--> statement-breakpoint
CREATE TABLE "quiz_questions" (
	"question_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"quiz_version_id" uuid NOT NULL,
	"position" integer NOT NULL,
...
CREATE TABLE "quiz_reviews" (
	"review_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"quiz_id" uuid NOT NULL,
	"user_id" uuid NOT NULL,
...
CREATE TABLE "quiz_tags" (
	"quiz_tag_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"quiz_id" uuid NOT NULL,
...
CREATE TABLE "quiz_versions" (
	"quiz_version_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"quiz_id" uuid NOT NULL,
...
CREATE TABLE "quizzes" (
	"quiz_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"creator_id" uuid,
	"title" text NOT NULL,
	"description" text,
	"slug" text NOT NULL,
...
CREATE TABLE "review_helpful_votes" (
	"vote_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
CREATE TABLE "review_reports" (
	"report_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"review_id" uuid NOT NULL,
	...
	CONSTRAINT "review_reports_reason_enum" CHECK (reason IN ('spam', 'harassment', 'inappropriate_content', 'misinformation', 'other'))
);
--> statement-breakpoint
CREATE TABLE "categories" (
	"category_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"name" text NOT NULL,
	"description" text,
	"slug" text NOT NULL,
	"image_url" text,
...
CREATE TABLE "category_follows" (
	"follow_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "tags" (
	"tag_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"name" text NOT NULL,
	"slug" text NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "rank_recalculation_work_items" (
	"work_item_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid NOT NULL,
	"period" text NOT NULL,
...
CREATE TABLE "badge_rules" (
	"rule_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "badges" (
	"badge_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"slug" text NOT NULL,
...
CREATE TABLE "user_badges" (
	"user_badge_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid NOT NULL,
	"badge_id" uuid NOT NULL,
...
CREATE TABLE "user_profile_settings" (
	"settings_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid NOT NULL,
...
CREATE TABLE "comment_reports" (
	...
	"reason" text NOT NULL,
	"details" text,
	"status" "comment_report_status" DEFAULT 'open' NOT NULL,
...
CREATE TABLE "comments" (
	"comment_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"quiz_id" uuid NOT NULL,
...
CREATE TABLE "blocked_users" (
	"block_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
CREATE TABLE "friendships" (
	"friendship_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
CREATE TABLE "social_feed_activities" (
	"activity_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid NOT NULL,
...
CREATE TABLE "notification_preferences" (
	"preferences_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid NOT NULL,
...
CREATE TABLE "tournament_participants" (
	"participant_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
CREATE TABLE "tournament_round_participants" (
	"round_participant_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
...
CREATE TABLE "tournament_rounds" (
	"round_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"tournament_id" uuid NOT NULL,
...
CREATE TABLE "tournaments" (
	"tournament_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"title" text NOT NULL,
	"description" text,
	"difficulty" "quiz_difficulty" NOT NULL,
...
CREATE TABLE "daily_challenge" (
	"challenge_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"expires_at" timestamp with time zone NOT NULL,
	CONSTRAINT "daily_challenge_reward_xp_nonneg" CHECK ("daily_challenge"."reward_xp" >= 0)
);
--> statement-breakpoint
CREATE TABLE "daily_challenge_attempt" (
	...
	"next_question_index" integer DEFAULT 0 NOT NULL,
	"total_questions" integer,
	"score_percent" numeric(5, 2),
	"completed_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "daily_challenge_attempt_index_nonneg" CHECK ("daily_challenge_attempt"."next_question_index" >= 0),
	CONSTRAINT "daily_challenge_attempt_score_range" CHECK ("daily_challenge_attempt"."score_percent" IS NULL OR ("daily_challenge_attempt"."score_percent" >= 0 AND "daily_challenge_attempt"."score_percent" <= 100))
);
--> statement-breakpoint
...
CREATE TABLE "coin_transactions" (
	"transaction_id" uuid PRIMARY KEY DEFAULT uuidv7() NOT NULL,
	"user_id" uuid NOT NULL,
	...
	"metadata" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "coin_transactions_amount_nonzero" CHECK ("coin_transactions"."amount" <> 0),
	CONSTRAINT "coin_transactions_balance_after_nonneg" CHECK ("coin_transactions"."balance_after" >= 0),
	CONSTRAINT "coin_transactions_metadata_object" CHECK (jsonb_typeof("coin_transactions"."metadata") = 'object'::text)
);
--> statement-breakpoint
CREATE TABLE "user_wallets" (
	...
	CONSTRAINT "user_wallets_balance_max" CHECK ("user_wallets"."balance" <= 1000000)
);
--> statement-breakpoint
...
ALTER TABLE "tournaments" ADD CONSTRAINT "tournaments_owner_user_id_fkey" FOREIGN KEY ("owner_user_id") REFERENCES "public"."users"("user_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "daily_challenge" ADD CONSTRAINT "daily_challenge_quiz_id_fkey" FOREIGN KEY ("quiz_id") REFERENCES "public"."quizzes"("quiz_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "daily_challenge" ADD CONSTRAINT "daily_challenge_quiz_version_id_fkey" FOREIGN KEY ("quiz_version_id") REFERENCES "public"."quiz_versions"("quiz_version_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "daily_challenge_attempt" ADD CONSTRAINT "daily_challenge_attempt_challenge_id_fkey" FOREIGN KEY ("challenge_id") REFERENCES "public"."daily_challenge"("challenge_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "daily_challenge_attempt" ADD CONSTRAINT "daily_challenge_attempt_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("user_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "coin_transactions" ADD CONSTRAINT "coin_transactions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("user_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_wallets" ADD CONSTRAINT "user_wallets_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("user_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_users_search_vector" ON "users" USING gin ("user_search_vector") WHERE deleted_at IS NULL;--> statement-breakpoint
...
CREATE INDEX "idx_quiz_instances_countdown_due" ON "quiz_instances" USING btree ("countdown_started_at" timestamptz_ops) WHERE "quiz_instances"."status" = 'countdown';--> statement-breakpoint
...
CREATE INDEX "idx_quiz_reviews_active_created_at_desc" ON "quiz_reviews" USING btree ("quiz_id","created_at" DESC NULLS LAST) WHERE "quiz_reviews"."deleted_at" IS NULL;--> statement-breakpoint
CREATE INDEX "idx_quiz_reviews_active_helpful_count_desc" ON "quiz_reviews" USING btree ("helpful_count" DESC NULLS LAST,"review_id" DESC NULLS LAST) WHERE "quiz_reviews"."deleted_at" IS NULL;--> statement-breakpoint
...
CREATE INDEX "idx_quiz_versions_quiz_status" ON "quiz_versions" USING btree ("quiz_id" uuid_ops,"status" enum_ops);--> statement-breakpoint
...
CREATE INDEX "idx_quizzes_category_id" ON "quizzes" USING btree ("category_id" uuid_ops) WHERE (category_id IS NOT NULL);--> statement-breakpoint
...
CREATE INDEX "idx_comment_reports_status_created" ON "comment_reports" USING btree ("status" enum_ops,"created_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_comment_reports_comment" ON "comment_reports" USING btree ("comment_id" uuid_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "uq_comment_reports_reporter_comment" ON "comment_reports" USING btree ("reporter_id" uuid_ops,"comment_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "idx_comments_quiz_created" ON "comments" USING btree ("quiz_id" uuid_ops,"created_at" timestamptz_ops) WHERE deleted_at IS NULL;--> statement-breakpoint
CREATE INDEX "idx_comments_author_created" ON "comments" USING btree ("author_id" uuid_ops,"created_at" timestamptz_ops) WHERE deleted_at IS NULL;--> statement-breakpoint
CREATE INDEX "idx_comments_parent_created" ON "comments" USING btree ("parent_comment_id" uuid_ops,"created_at" timestamptz_ops) WHERE deleted_at IS NULL;--> statement-breakpoint
CREATE INDEX "idx_comments_quiz_parent_created" ON "comments" USING btree ("quiz_id" uuid_ops,"parent_comment_id" uuid_ops,"created_at" timestamptz_ops) WHERE deleted_at IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "uq_comment_votes_user_comment" ON "comment_votes" USING btree ("user_id" uuid_ops,"comment_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "idx_comment_votes_comment" ON "comment_votes" USING btree ("comment_id" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "idx_notifications_metadata" ON "notifications" USING gin (metadata);--> statement-breakpoint
...
CREATE INDEX "idx_tournaments_owner_active" ON "tournaments" USING btree ("owner_user_id" uuid_ops) WHERE (deleted_at IS NULL);--> statement-breakpoint
CREATE UNIQUE INDEX "uq_daily_challenge_date" ON "daily_challenge" USING btree ("challenge_date" date_ops);--> statement-breakpoint
CREATE INDEX "idx_daily_challenge_expires_at" ON "daily_challenge" USING btree ("expires_at" timestamptz_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "uq_daily_challenge_attempt_user_challenge" ON "daily_challenge_attempt" USING btree ("user_id" uuid_ops,"challenge_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "idx_daily_challenge_attempt_user_created" ON "daily_challenge_attempt" USING btree ("user_id" uuid_ops,"created_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_daily_challenge_attempt_challenge" ON "daily_challenge_attempt" USING btree ("challenge_id" uuid_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "uq_outbox_events_idempotency_unprocessed" ON "outbox_events" USING btree ("idempotency_key" text_ops) WHERE processed_at IS NULL AND idempotency_key IS NOT NULL;--> statement-breakpoint
CREATE INDEX "idx_coin_transactions_user_cursor" ON "coin_transactions" USING btree ("user_id" uuid_ops,"created_at" timestamptz_ops,"transaction_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "idx_coin_transactions_user_reason_created" ON "coin_transactions" USING btree ("user_id" uuid_ops,"reason" enum_ops,"created_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_coin_transactions_user_created" ON "coin_transactions" USING btree ("user_id" uuid_ops,"created_at" timestamptz_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "uq_coin_transactions_idempotency_key" ON "coin_transactions" USING btree ("idempotency_key" text_ops);