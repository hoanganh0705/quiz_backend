/**
 * Comment module error-response examples.
 *
 ...
 * by `comment-swagger-decorators.ts` and use the `instance` path of
...
const EXAMPLE_BY_STATUS = {
  ...
  forbidden: {
    ...
    instance: '/api/v1/endpoint',
    extensions: { requestId: REQUEST_ID, code: 'COMMENT_FORBIDDEN' },
  },
  notFound: {
    ...
    instance: '/api/v1/endpoint',
    extensions: { requestId: REQUEST_ID, code: 'COMMENT_NOT_FOUND' },
  },
  conflict: {
...
export const createCommentQuizNotFoundExample = {
  ...
  instance: '/quizzes/660e8400-e29b-71d4-a716-446655440000/comments',
  extensions: { requestId: REQUEST_ID, code: 'COMMENT_QUIZ_NOT_FOUND' },
};
...
export const createCommentParentNotFoundExample = {
  ...
  instance: '/quizzes/660e8400-e29b-71d4-a716-446655440000/comments',
  extensions: { requestId: REQUEST_ID, code: 'COMMENT_PARENT_COMMENT_NOT_FOUND' },
};
...
export const createCommentReplyLimitExample = {
  ...
  instance: '/quizzes/660e8400-e29b-71d4-a716-446655440000/comments',
  extensions: { requestId: REQUEST_ID, code: 'COMMENT_REPLY_LIMIT_EXCEEDED' },
};
...
export const voteSelfVoteExample = {
  ...
  extensions: { requestId: REQUEST_ID, code: 'COMMENT_SELF_VOTE' },
};
...
export const reportCommentSelfReportExample = {
  ...
  extensions: { requestId: REQUEST_ID, code: 'COMMENT_SELF_REPORT' },
};
...
export const reportCommentDuplicateExample = {
  ...
  instance: '/comments/880e8400-e29b-71d4-a716-446655440001/reports',
  extensions: { requestId: REQUEST_ID, code: 'COMMENT_DUPLICATE_REPORT' },
};
...
export const hideCommentModeratorRequiredExample = {
  ...
  extensions: { requestId: REQUEST_ID, code: 'COMMENT_MODERATOR_REQUIRED' },
};
...
export const reviewReportNotFoundExample = {
  ...
  instance: reviewInstance,
  extensions: { requestId: REQUEST_ID, code: 'COMMENT_REPORT_NOT_FOUND' },
};
