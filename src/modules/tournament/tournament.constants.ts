...
export const TOURNAMENT_REGISTRATION_DEADLINE_PASSED_MESSAGE = 'Tournament registration deadline has passed';
export const TOURNAMENT_FULL_MESSAGE = 'Tournament is full';
export const TOURNAMENT_ALREADY_REGISTERED_MESSAGE = 'You are already registered for this tournament';
...
export const TOURNAMENT_ATTEMPT_ALREADY_EXISTS_MESSAGE = 'You have already submitted an attempt for this round';
