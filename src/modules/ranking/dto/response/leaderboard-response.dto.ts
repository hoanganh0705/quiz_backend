...
export class PeriodInfoDto {
  @ApiProperty({ description: 'Period type', enum: ['weekly', 'monthly', 'all_time'], example: 'weekly' })
  type: 'weekly' | 'monthly' | 'all_time';

  @ApiProperty({ description: 'Period start date', example: '2026-05-25T00:00:00.000Z' })
  start: string;

  @ApiPropertyOptional({ description: 'Period end date (null for all_time)', example: '2026-05-31T23:59:59.999Z' })
  end: string | null;
...
export class UserRankPositionDto {
  ...
  @ApiProperty({ description: 'Rank trend compared to previous', enum: ['up', 'down', 'same', 'new'] })
