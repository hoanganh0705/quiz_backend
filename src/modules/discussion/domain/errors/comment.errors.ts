...
/**
 * Discussion-module namespace marker for comment-domain exceptions.
 *
...
/**
 * Thrown when the discussion module's `QuizNotFoundError` fires (quiz
...
export class ParentCommentNotFoundError extends CommentError {
  readonly code = 'DISCUSSION_PARENT_COMMENT_NOT_FOUND';
...
export class ParentCommentCrossThreadError extends CommentError {
  readonly code = 'DISCUSSION_PARENT_COMMENT_CROSS_THREAD';
  constructor() {
...
export class ReportNotFoundError extends CommentError {
  readonly code = 'DISCUSSION_REPORT_NOT_FOUND';
