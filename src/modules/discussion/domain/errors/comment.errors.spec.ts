...
const COMMENT_CASES: ReadonlyArray<{
  ...
  },
  {
    ...
    args: ['parent-1'],
    expectedCode: 'DISCUSSION_PARENT_COMMENT_NOT_FOUND',
  ...
  },
  {
    ...
    args: [],
    expectedCode: 'DISCUSSION_PARENT_COMMENT_CROSS_THREAD',
  ...
  },
  {
    ...
    args: ['100'],
    expectedCode: 'DISCUSSION_REPLY_LIMIT_EXCEEDED',
  ...
  },
  {
    ...
    args: ['report-1'],
    expectedCode: 'DISCUSSION_REPORT_NOT_FOUND',
...
describe('Comment-domain errors (RFC 7807 mapping completeness — Phase 9.5)', () => {
  ...
  describe('aggregate invariants', () => {
    ...
    it('the non-obvious 400 mapping for ParentCommentCrossThreadError is preserved (regression guard for §8.4.1 risk note)', () => {
      ...
      expect(ProblemCodeMapping['DISCUSSION_PARENT_COMMENT_CROSS_THREAD'].status).toBe(
    ...
    it('the non-obvious 403 mapping for ModeratorRequiredError is preserved (regression guard for §8.4.1 risk note)', () => {
      ...
      expect(ProblemCodeMapping['DISCUSSION_MODERATOR_REQUIRED'].status).toBe(
