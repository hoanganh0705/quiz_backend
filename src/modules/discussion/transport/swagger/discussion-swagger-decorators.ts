  ...
  applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        ...
        'same quiz. Replies to replies are rejected with `DISCUSSION_PARENT_COMMENT_CROSS_THREAD`.',
    }),
      ...
      applyDecorators(
        ...
        ApiOperation({
          ...
          description:
            ...
            '`DISCUSSION_COMMENT_FORBIDDEN` when the caller is not the author.',
        }),
        ApiBadRequestResponse(
      ...
      applyDecorators(
        ...
        ApiOperation({
          ...
          description:
            ...
            '`DISCUSSION_DUPLICATE_REPORT` when you already have an open report ' +
            'against the same comment, and 403 `DISCUSSION_SELF_REPORT` if you ' +
      ...
      applyDecorators(
        ...
        ApiOperation({
          ...
          description:
            ...
            'Requires the `DISCUSSION_MODERATE` permission.',
        }),
      ...
      applyDecorators(
        ...
        ApiOperation({
          ...
          description:
            ...
            '`DISCUSSION_MODERATE` permission. No-op if the comment was not hidden.',
        }),
      ...
      applyDecorators(
        ...
        ApiOperation({
          ...
          description:
            ...
            '`actioned` reports. Requires the `DISCUSSION_MODERATE` permission.',
        }),
      ...
      applyDecorators(
        ...
        ApiOperation({
          ...
          description:
            ...
            'the underlying comment. Requires the `DISCUSSION_MODERATE` permission.',
        }),
        ApiBadRequestResponse(
          problem.badRequest(
            reviewReportBadRequestExample,
